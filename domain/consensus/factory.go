...
import (
	...
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/daawindowstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/e4p1k0/pyipad/domain/consensus/model"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/e4p1k0/pyipad/domain/consensus/processes/parentsmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/pruningproofmanager"
	...
	consensusdatabase "github.com/e4p1k0/pyipad/domain/consensus/database"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/acceptancedatastore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/blockheaderstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/blockrelationstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/blockstatusstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/blockstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/consensusstatestore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/daablocksstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/finalitystore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/multisetstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/pruningstore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/e4p1k0/pyipad/domain/consensus/datastructures/utxodiffstore"
	"github.com/e4p1k0/pyipad/domain/consensus/model/externalapi"
	"github.com/e4p1k0/pyipad/domain/consensus/model/testapi"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/blockbuilder"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/blockprocessor"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/blockvalidator"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/coinbasemanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/consensusstatemanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/dagtopologymanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/dagtraversalmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/difficultymanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/finalitymanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/ghostdagmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/headersselectedtipmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/mergedepthmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/pastmediantimemanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/pruningmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/reachabilitymanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/syncmanager"
	"github.com/e4p1k0/pyipad/domain/consensus/processes/transactionvalidator"
